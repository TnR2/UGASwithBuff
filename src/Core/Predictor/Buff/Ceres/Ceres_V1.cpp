...
double Ceres_V1::PredictDeltaAngle(TimeStamp now, TimeStamp predict_timeStamp) const
{
...
double Ceres_V1::shiftWindowFilter(BuffAngularSpeed buffSpeed)
{

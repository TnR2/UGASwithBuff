...
private:
    ...
    Buff5PointIdentifyData _last_data;		    //
    cv::Mat _img;							    //
...
public:
    BuffIdentifier_V6(): _thread(&BuffIdentifier_V6::classMain, this) {
        ...
        _size_model = 640;
        _compiled_model = _core.compile_model("../models/buffsj_4000.onnx", "GPU");
    ...
    std::optional<Buff5PointIdentifyData> Update(const cv::Mat& img, const TimeStamp& timeStamp, const IMUTransformer transformer, const ArmorColor enemyColor){
        if (_free) {
